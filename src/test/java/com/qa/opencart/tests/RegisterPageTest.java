...
public class RegisterPageTest extends BaseTest{
	...
	public void userRegisterTest(String firstName,String lastName,String mobileNo,String password,String subscription) {
		Assert.assertTrue(regPage.registerUser(firstName, lastName, getRandomEmailId(),mobileNo,password,subscription));
